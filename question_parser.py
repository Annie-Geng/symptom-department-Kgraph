...
class QuestionPaser:
    ...
    def parser_main(self, res_classify):
        ...
        for question_type in question_types:
            ...
            if question_type == 'symptom_department':
                sql = self.sql_transfer(question_type, entity_dict.get('symptom'))
    ...
    def sql_transfer(self, question_type, entities):
        ...
        if question_type == 'disease_department':
            ...
            sql = ["MATCH (p:Symptom)<-[r2:has_symptom]-(m:Disease)-[r1:belongs_to]->(n:Department) where p.name = '{0}' return p.name, r2.name, m.name,m.get_prob, r1.name, n.name".format(i) for i in entities]
